...
class CurrencyRegistry {
  static final Map<String, CurrencyUnit> byCode = {
    ...
    'JPY': const CurrencyUnit(code: 'JPY', englishSingular: 'yen', englishPlural: 'yen', thaiName: 'เยน'),
    ...
    'CNY': const CurrencyUnit(code: 'CNY', englishSingular: 'renminbi', englishPlural: 'renminbi', thaiName: 'หยวนเหรินหมินปี้'),
    'KRW': const CurrencyUnit(code: 'KRW', englishSingular: 'won', englishPlural: 'won', thaiName: 'วอน'),
    'VND': const CurrencyUnit(code: 'VND', englishSingular: 'dong', englishPlural: 'dong', thaiName: 'ดอง'),
    'LAK': const CurrencyUnit(code: 'LAK', englishSingular: 'kip', englishPlural: 'kip', thaiName: 'กีบ'),
    'KWD': const CurrencyUnit(code: 'KWD', englishSingular: 'dinar', englishPlural: 'dinars', thaiName: 'ดีนาร์คูเวต'),
    'SAR': const CurrencyUnit(code: 'SAR', englishSingular: 'riyal', englishPlural: 'riyals', thaiName: 'ริยัลซาอุดีอาระเบีย'),
