...
แพ็กเกจนี้ช่วยแปลงตัวเลขเป็นข้อความภาษาไทย เช่น จำนวนเต็ม บาท/สตางค์ ทศนิยม เศษส่วน และอ่านทีละหลัก รวมทั้งรองรับตัวเลขไทย (๐–๙) และเลขโรมัน พร้อมฟังก์ชันปรับแต่งคำอ่านได้ตามต้องการ
